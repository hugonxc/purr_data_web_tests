...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'pdtest.data';
      var REMOTE_PACKAGE_BASE = 'pdtest.data';
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_pdtest.data');

      };
      Module['addRunDependency']('datafile_pdtest.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5395984,
    DYNAMIC_BASE = 5395984,
    DYNAMICTOP_PTR = 152912;
...
var wasmBinaryFile = 'pdtest.wasm';
...
var ASM_CONSTS = [function() { return screen.width; },
 ...
 function($0) { if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0; },
...
function nullFunc_if(x) { abortFnPtrError(x, 'if'); }
function nullFunc_iff(x) { abortFnPtrError(x, 'iff'); }
function nullFunc_ifff(x) { abortFnPtrError(x, 'ifff'); }
function nullFunc_iffff(x) { abortFnPtrError(x, 'iffff'); }
function nullFunc_ifffff(x) { abortFnPtrError(x, 'ifffff'); }
...
function nullFunc_iiffff(x) { abortFnPtrError(x, 'iiffff'); }
function nullFunc_iifffff(x) { abortFnPtrError(x, 'iifffff'); }
function nullFunc_iii(x) { abortFnPtrError(x, 'iii'); }
function nullFunc_iiif(x) { abortFnPtrError(x, 'iiif'); }
function nullFunc_iiiff(x) { abortFnPtrError(x, 'iiiff'); }
function nullFunc_iiifff(x) { abortFnPtrError(x, 'iiifff'); }
function nullFunc_iiiffff(x) { abortFnPtrError(x, 'iiiffff'); }
function nullFunc_iiifffff(x) { abortFnPtrError(x, 'iiifffff'); }
function nullFunc_iiii(x) { abortFnPtrError(x, 'iiii'); }
function nullFunc_iiiif(x) { abortFnPtrError(x, 'iiiif'); }
function nullFunc_iiiiff(x) { abortFnPtrError(x, 'iiiiff'); }
function nullFunc_iiiifff(x) { abortFnPtrError(x, 'iiiifff'); }
function nullFunc_iiiiffff(x) { abortFnPtrError(x, 'iiiiffff'); }
function nullFunc_iiiifffff(x) { abortFnPtrError(x, 'iiiifffff'); }
function nullFunc_iiiii(x) { abortFnPtrError(x, 'iiiii'); }
function nullFunc_iiiiif(x) { abortFnPtrError(x, 'iiiiif'); }
function nullFunc_iiiiiff(x) { abortFnPtrError(x, 'iiiiiff'); }
function nullFunc_iiiiifff(x) { abortFnPtrError(x, 'iiiiifff'); }
function nullFunc_iiiiiffff(x) { abortFnPtrError(x, 'iiiiiffff'); }
function nullFunc_iiiiifffff(x) { abortFnPtrError(x, 'iiiiifffff'); }
function nullFunc_iiiiii(x) { abortFnPtrError(x, 'iiiiii'); }
function nullFunc_iiiiiidii(x) { abortFnPtrError(x, 'iiiiiidii'); }
function nullFunc_iiiiiif(x) { abortFnPtrError(x, 'iiiiiif'); }
function nullFunc_iiiiiiff(x) { abortFnPtrError(x, 'iiiiiiff'); }
function nullFunc_iiiiiifff(x) { abortFnPtrError(x, 'iiiiiifff'); }
function nullFunc_iiiiiiffff(x) { abortFnPtrError(x, 'iiiiiiffff'); }
function nullFunc_iiiiiifffff(x) { abortFnPtrError(x, 'iiiiiifffff'); }
function nullFunc_iiiiiii(x) { abortFnPtrError(x, 'iiiiiii'); }
function nullFunc_iiiiiiif(x) { abortFnPtrError(x, 'iiiiiiif'); }
function nullFunc_iiiiiiiff(x) { abortFnPtrError(x, 'iiiiiiiff'); }
function nullFunc_iiiiiiifff(x) { abortFnPtrError(x, 'iiiiiiifff'); }
function nullFunc_iiiiiiiffff(x) { abortFnPtrError(x, 'iiiiiiiffff'); }
function nullFunc_iiiiiiifffff(x) { abortFnPtrError(x, 'iiiiiiifffff'); }
function nullFunc_iiiiiiiffiiiiii(x) { abortFnPtrError(x, 'iiiiiiiffiiiiii'); }
...
function nullFunc_vfffff(x) { abortFnPtrError(x, 'vfffff'); }
...
function nullFunc_vifffff(x) { abortFnPtrError(x, 'vifffff'); }
...
function nullFunc_viiffff(x) { abortFnPtrError(x, 'viiffff'); }
function nullFunc_viifffff(x) { abortFnPtrError(x, 'viifffff'); }
...
function nullFunc_viiifff(x) { abortFnPtrError(x, 'viiifff'); }
function nullFunc_viiiffff(x) { abortFnPtrError(x, 'viiiffff'); }
function nullFunc_viiifffff(x) { abortFnPtrError(x, 'viiifffff'); }
...
function nullFunc_viiiifff(x) { abortFnPtrError(x, 'viiiifff'); }
function nullFunc_viiiiffff(x) { abortFnPtrError(x, 'viiiiffff'); }
function nullFunc_viiiifffff(x) { abortFnPtrError(x, 'viiiifffff'); }
function nullFunc_viiiiffi(x) { abortFnPtrError(x, 'viiiiffi'); }
function nullFunc_viiiiffii(x) { abortFnPtrError(x, 'viiiiffii'); }
function nullFunc_viiiiffiiii(x) { abortFnPtrError(x, 'viiiiffiiii'); }
function nullFunc_viiiii(x) { abortFnPtrError(x, 'viiiii'); }
function nullFunc_viiiiif(x) { abortFnPtrError(x, 'viiiiif'); }
function nullFunc_viiiiiff(x) { abortFnPtrError(x, 'viiiiiff'); }
function nullFunc_viiiiifff(x) { abortFnPtrError(x, 'viiiiifff'); }
function nullFunc_viiiiiffff(x) { abortFnPtrError(x, 'viiiiiffff'); }
function nullFunc_viiiiifffff(x) { abortFnPtrError(x, 'viiiiifffff'); }
function nullFunc_viiiiii(x) { abortFnPtrError(x, 'viiiiii'); }
function nullFunc_viiiiiif(x) { abortFnPtrError(x, 'viiiiiif'); }
function nullFunc_viiiiiiff(x) { abortFnPtrError(x, 'viiiiiiff'); }
function nullFunc_viiiiiifff(x) { abortFnPtrError(x, 'viiiiiifff'); }
function nullFunc_viiiiiiffff(x) { abortFnPtrError(x, 'viiiiiiffff'); }
function nullFunc_viiiiiifffff(x) { abortFnPtrError(x, 'viiiiiifffff'); }
...
var dynCall_ifffff = Module["dynCall_ifffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_ifffff"].apply(null, arguments)
};
...
/** @type {function(...*):?}
*/
var dynCall_iiiiifffff = Module["dynCall_iiiiifffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iiiiifffff"].apply(null, arguments)
};
...
/** @type {function(...*):?}
*/
var dynCall_iiiiiifffff = Module["dynCall_iiiiiifffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iiiiiifffff"].apply(null, arguments)
};
...
/** @type {function(...*):?}
*/
var dynCall_iiiiiiifff = Module["dynCall_iiiiiiifff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iiiiiiifff"].apply(null, arguments)
};
...
/** @type {function(...*):?}
*/
var dynCall_iiiiiiifffff = Module["dynCall_iiiiiiifffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iiiiiiifffff"].apply(null, arguments)
};
...
var dynCall_iiiiiiiffiiiiii = Module["dynCall_iiiiiiiffiiiiii"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_iiiiiiiffiiiiii"].apply(null, arguments)
};
...
var dynCall_vfffff = Module["dynCall_vfffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_vfffff"].apply(null, arguments)
};
...
/** @type {function(...*):?}
*/
var dynCall_viiiifffff = Module["dynCall_viiiifffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiiifffff"].apply(null, arguments)
};
...
var dynCall_viiiiifff = Module["dynCall_viiiiifff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiiiifff"].apply(null, arguments)
};
...
/** @type {function(...*):?}
*/
var dynCall_viiiiifffff = Module["dynCall_viiiiifffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiiiifffff"].apply(null, arguments)
};
...
/** @type {function(...*):?}
*/
var dynCall_viiiiiifff = Module["dynCall_viiiiiifff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiiiiifff"].apply(null, arguments)
};

/** @type {function(...*):?}
*/
var dynCall_viiiiiiffff = Module["dynCall_viiiiiiffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiiiiiffff"].apply(null, arguments)
};

/** @type {function(...*):?}
*/
var dynCall_viiiiiifffff = Module["dynCall_viiiiiifffff"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["dynCall_viiiiiifffff"].apply(null, arguments)
};
